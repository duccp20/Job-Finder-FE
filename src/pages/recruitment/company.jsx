    ...
    <div className="flex sm:flex-col-reverse tablet-range:flex-col-reverse">
      <div className="ml-[40px] flex w-[65%] flex-col gap-[10px] pr-[30px] leading-normal text-inherit tablet-up:ml-[40px] tablet-up:mr-[10px] tablet-up:w-auto desktop-up:mr-[10px] desktop-up:mt-[30px] ">
        ...
        <p className="my-[10px]">
          ...
          dành cho DevOps,…nhằm giúp các bạn trang bị những kinh nghiệm làm việc
          như quản lý source code, viết code sạch, làm việc nhóm, cách hỏi đáp
          để làm rõ yêu cầu,….Hiện nay, R2S Academy có hàng chục khoá học và có
          gần 500 học viên đã và đang học. Trong số những học viên tham gia tại
          R2S Academy, với hình thức đào tạo online nên các bạn có cơ hội gặp gỡ
          nhau ở mọi miền đất nước. Thậm chí có những bạn đang ở Đức, Ý, Nhật,
          Hàn Quốc, Malaysia cũng tham gia học.
        </p>
        <p>
          Với mô hình đào tạo, phát triển phần mềm và kết nối doanh nghiệp, R2S
          đã tạo ra môi trường học tập sát với nhu cầu thực tế. Không những thế,
          học viên còn có cơ hội thực tập và được R2S tuyển dụng. Một hệ sinh
          thái kết nối việc học, thực hành gắn liền thực tế nên học viên có cơ
          hội học những gì doanh nghiệp cần, tích luỹ kinh nghiệm thông qua các
          buổi học và có cơ hội việc làm ngay và sau khi kết thúc khoá học. R2S
          coi trọng đến triết lý kinh doanh “TẬN TUỴ phục vụ KHÁCH HÀNG, tạo
          NIỀM TIN với ĐỐI TÁC, CHĂM LO đời sống NHÂN VIÊN, ĐÓNG GÓP thiết thực
          cho CỘNG ĐỒNG“. Đây chính là kim chỉ nam để toàn thể nhân viên R2S
          cùng hành động.
        </p>
        <div
